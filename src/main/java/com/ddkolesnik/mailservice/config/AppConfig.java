  ...
  public SimpleMailMessage templateSimpleMessage() {
    ...
    message.setText(
        "Здравствуйте, уважаемый Инвестор!<br/>" +
            "Вы зарегистрировались на сайте Инвестиционной Платформы \"Колесник.Инвестиции\" и мы рады Вас приветствовать!<br/>" +
            "Чтобы начать инвестировать, вам необходимо в своем личном кабинете заполнить анкетные данные и подгрузить сканы/фото документов. Это не займет много времени.<br/><br/>" +
            "Данные для входа:<br/><br/>" +
            "login: Ваш номер телефона<br/>" +
            "Пароль: %s<br/><br/>" +
            "Ссылка на платформу https://www.lk.ddkolesnik.com<br/><br/>" +
            "Если у Вас остались вопросы или Вам необходима персональная консультация, нажмите на кнопку и наш сотрудник свяжется с вами<br/>" +
            "Получить консультацию t.me/ddkclient_bot<br/><br/>" +
            "С уважением,<br/>" +
            "команда \"Колесник.Инвестиции\"");
    return message;
  }
